...
export class AppComponent implements AfterViewInit {
  ...
  lightTheme = this.themeSelectionService.isLightTheme();
              ...
              private messageDownloaderService: MessageDownloaderService) 
  {
    ...
    if (this.lightTheme) {
      ...
      this.elementRef.nativeElement.ownerDocument.body.style.backgroundColor = '#282a36';
    }
  }
  ...
  switchColor() {
    ...
    this.themeSelectionService.switchTheme();
  }
